...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/Nasmedia-Tech/iOS-SSP-NAM-SPM/releases/download/1.2.0/AdMixerMediationNAM1.2.0.xcframework.zip",
            checksum: "4beb67d9a9890e4621f39705775da32c2c310bae6fce95fe382797548e43707a"
        ),
        .target(
